...
from .reporter import OUTPUT, format_output, format_value, format_variable
...
def generate_trace_display(
    ...
    for variable in current_assignments.keys():
        table.add_column(format_variable(variable), justify="right")
    table.add_column(OUTPUT, justify="right")

    row = [format_value(v) for v in current_assignments.values()]
