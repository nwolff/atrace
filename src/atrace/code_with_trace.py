...
from . import Filters, History, Trace, trace_next_loaded_module, trace_to_history
...
def run():
    ...
    def done_callback(trace: Trace):
        history = trace_to_history(trace, Filters.NONE | Filters.FUNCTION_ASSIGNMENT)
